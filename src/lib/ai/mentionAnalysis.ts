...
function buildPrompt(mentions: MentionForAnalysis[]): string {
  ...
  return [
    ...
    '1) "entities": لائحة كل الشخصيات السياسية/المرشحين المذكورين أو المقصودين فعليا فالنص (ماشي ذكر عابر بلا سياق سياسي، وماشي صحافيين/مذيعين). إذا كانت الشخصية من هاد اللائحة المعروفة سلفا، اكتب اسمها بالضبط كما هو هنا بلا تغيير: ' +
      knownList +
      ". إذا كانت شخصية سياسية أخرى (مرشح/مسؤول/منتخب محلي) غير موجودة فهاد اللائحة، اكتب اسمها الكامل كما ظهر بالضبط فالنص. إذا ماكاينش أي شخصية سياسية، أرجع لائحة فارغة.",
