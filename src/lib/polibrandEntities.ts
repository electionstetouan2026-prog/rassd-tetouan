...
export const RIVALS: RivalEntity[] = [
  ...
  // زيادة 17 شتنبر 2026 — تأكيد كامل للائحة الـ17 الرسمية (بوابة
  // elections.ma) بمساعدة علي: وكيل لائحة حزب الوحدة والديمقراطية
  // (PUD) بدائرة تطوان، آخر اسم ناقص من أصل 17 لائحة
  { name: "الهاشمي بوغيث", terms: ["الهاشمي بوغيث", "بوغيث"] },
];

export const ALL_ENTITY_NAMES = [OUR_CANDIDATE_KEY, ...RIVALS.map((r) => r.name)];

// أسماء سياسية وطنية (وزراء، أمناء عامون لأحزاب على المستوى الوطني...)
// كتبان أحيانا فأخبار سياسية عامة عن الانتخابات (ماشي خاصة بدائرة
// تطوان) وكتنقاد بالخطأ عبر الاكتشاف التلقائي بالـAI (ai_entities) —
// طلب علي 17 شتنبر 2026 بعد ما شاف أسماء بحال نزار بركة وناصر بوريطة
// ونبيلة منيب طالعين فالترتيب رغم أنهم ماعندهمش علاقة بدائرتنا. هاد
// اللائحة كتفلترهم فـ digitalRanking.ts (getOrCreate) قبل ما يتحسبو،
// بلا حاجة لإعادة تحليل AI. زيد هنا أي اسم وطني آخر كيبان بالغلط.
export const NATIONAL_NOISE_EXCLUSIONS = [
